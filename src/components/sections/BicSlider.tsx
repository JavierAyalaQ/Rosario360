...
const ImageSlider: React.FC = () => {
    return (
      <div className="w-full max-w-7xl absolute bottom-0 z-50 transition-transform duration-700 hover:opacity-100 transform translate-y-1/2 hover:-translate-y-1/4">
        <Swiper
          loop={true}
